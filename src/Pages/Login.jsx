        ...
        <div><title>Log in</title></div>
{
  ...
  <div className=" flex-col flex justify-center items-center ">
    ...
    <div className="card bg-secondary/30 w-full max-w-md shrink-0 shadow-2xl">
...
<p>Don't have an account? please <Link className='text-secondary' to='/auth/register' state={location.state}>Sign up</Link></p>
      </div>
    </div>
  </div>
</div>
