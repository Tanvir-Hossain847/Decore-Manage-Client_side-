...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const gmailURL = `https://mail.google.com/mail/?view=cm&fs=1
      &to=tanvirhossaintufa@gmail.com
      &su=New Contact Request
      &body=
      Name: ${formData.name}%0A
      Email: ${formData.email}%0A
      Phone: ${formData.phone}%0A
      Event Type: ${formData.eventType}%0A
      Event Date: ${formData.date}%0A%0A
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Email",
      details: ["tanvirhossaintufa@gmail.com", "lagonlegend847@gmail.com"],
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Have a question or ready to book? We'd love to hear from you. Fill
              out the form below or reach out through any of our contact
              channels.
            </p>
          </motion.div>
        </div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Get expert advice on your decoration needs at no cost
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
