            ...
            <ul className="menu w-full grow space-y-3">
              ...
              <li>
                <Link to={"/dashboard/create_service"}>
                  ...
                  >
                    <LucideSticker className="text-secondary"></LucideSticker>
                    <span className="is-drawer-close:hidden">
                      Create Service
                    </span>
                  </button>
              ...
              <li>
                <Link to={"/dashboard/revenue"}>
                  ...
                  >
                    <LucideMonitorCheck className="text-secondary"></LucideMonitorCheck>
                    <span className="is-drawer-close:hidden">
                      Revenue Chart
                    </span>
                  </button>
              ...
              <li>
                <Link to={"/dashboard/service_demand"}>
                  ...
                  >
                    <LucideChartBar className="text-secondary"></LucideChartBar>
                    <span className="is-drawer-close:hidden">
